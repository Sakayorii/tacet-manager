...
android {
    ...
    defaultConfig {
        applicationId = "app.tacet.manager"
        minSdk = 28
        targetSdk = 34
        ...
        buildConfigField("String", "MOD_NAME", "\"Tacet\"")
        buildConfigField("String", "MANAGER_NAME", "\"TacetManager\"")
        buildConfigField("String", "REPO", "\"sakayorii/tacet-bundle-next\"")
        buildConfigField("String", "ORG_LINK", "\"https://github.com/sakayorii\"")
        buildConfigField("String", "INVITE_LINK", "\"https://discord.gg/Q8NEcegvz7\"")
        buildConfigField("String", "MODDED_APP_PACKAGE_NAME", "\"app.tacet\"")
